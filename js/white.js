...
function findCurrentSearchToArray(currentArrayData) {
	var result = {"item": undefined, "index": -1};
	try {
...
function createPageItem(item) {
	...
	textContent += '<li><a id="' + item_search + '" href="../' + offer + '#' + item_search + '" onclick="getCurrentItemURL(); return false;" target="_blank"><div class="img_wrapper"><img src="' + currentImage + '" title="' + item_title + '" alt="' + item_title + '"></div></a></li>';
	textContent += '</ol>';
